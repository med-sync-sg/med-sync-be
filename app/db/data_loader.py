...
# Helper function: embed text using the model
...
def find_content_dictionary(keyword_dict: dict, category: str) -> dict:
    ...
    input_embedding = model.encode(json.dumps(keyword_dict), normalize_embeddings=True)
    input_embedding_list = input_embedding.tolist()
    input_embedding_str = str(input_embedding_list)
...
# (Additional processing or function calls can be added below as needed.)
